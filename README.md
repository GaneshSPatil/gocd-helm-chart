...
| `server.image.tag`                | GoCD server image tag                     | `v17.10.0`         |
...
| `server.service.nodeHttpPort`     | GoCD server service node HTTP port        | `nil`              |  
| `server.service.nodeHttpsPort`    | GoCD server service node HTTPS port       | `nil`              |  
...
| `agent.image.tag`                           | GoCD agent image tag                            | `v17.10.0`                   |
| `agent.image.pullPolicy`                    | Image pull policy                               | `IfNotPresent`               |
| `agent.image.goServerUrl`                   | GoCD Server Url                                 | `nil`                        |
| `agent.image.agentAutoRegisterKey`          | GoCD Agent autoregister key                     | `nil`                        |
| `agent.image.agentAutoRegisterResources`    | Comma separated list of GoCD Agent resources    | `nil`                        |
| `agent.image.agentAutoRegisterEnvironemnts` | Comma separated list of GoCD Agent environments | `nil`                        |
| `agent.image.agentAutoRegisterHostname`     | GoCD Agent hostname                             | `nil`                        |
